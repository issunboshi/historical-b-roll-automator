...
def main(argv: Optional[List[str]] = None) -> int:
    ...
    parser.add_argument(
        "--model",
        help="Model name (default: claude-3-haiku-20240307 for anthropic, gpt-4o-mini for openai)",
    )
    ...
    if not args.model:
        args.model = "claude-3-haiku-20240307" if args.provider == "anthropic" else "gpt-4o-mini"
